...
export const routes: Routes = [
  ...
  { path: 'register', component: RegisterComponent, title: 'ลงทะเบียนองค์กร - Green Sync' },
  {
    ...
    title: 'ลงทะเบียนผู้ตรวจประเมิน - Green Sync',
  },
  {
  ...
  },
  {
    ...
    title: 'นโยบายความเป็นส่วนตัว - Green Sync',
  },
  {
    path: 'terms',
    loadComponent: () => import('./features/legal/terms/terms').then((m) => m.TermsComponent),
    title: 'ข้อตกลงการให้บริการ - Green Sync',
  },
  {
    path: 'assessor/report/:id',
    loadComponent: () =>
      import('./features/assessor/report/report').then((m) => m.AssessorReportComponent),
  ...
  // 3. หน้าที่ต้องผ่านการ Login และใช้ Layout ร่วมกัน (Sidebar/Header)
  {
    ...
    children: [
      ...
      },
      {
        path: 'admin/criteria',
        loadComponent: () =>
          import('./features/admin/criteria/criteria').then((m) => m.AdminCriteriaComponent),
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./features/admin/organizations/organizations').then(
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./features/admin/emission-factors/emission-factors').then(
            (m) => m.AdminEmissionFactorsComponent,
          ),
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./features/admin/assessors/assessors').then((m) => m.AdminAssessorsComponent),
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./features/admin/subscriptions/subscriptions').then(
      ...
      },
      {
        path: 'admin/invoices',
        loadComponent: () =>
          import('./features/admin/invoices/invoices').then((m) => m.AdminInvoicesComponent),
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./features/admin/audit-logs/audit-logs').then((m) => m.AdminAuditLogsComponent),
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./features/admin/notifications/notifications-admin.component').then(
      ...
      // GROUP: ASSESSOR ADMIN PAGES
      {
        ...
        loadComponent: () =>
          import('./features/assessor-admin/dashboard/dashboard').then((m) => m.Dashboard),
      ...
      // GROUP: ASSESSOR PAGES
      {
        ...
        loadComponent: () =>
          import('./features/assessor/dashboard/dashboard').then(
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./features/assessor/assignments/assignments').then(
            (m) => m.AssessorAssignmentsComponent,
          ),
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./features/assessor/evidence-review/evidence-review').then(
            (m) => m.AssessorEvidenceReviewComponent,
          ),
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./features/assessor/certification-decision/certification-decision').then(
            (m) => m.AssessorCertificationDecisionComponent,
          ),
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./features/assessor/history/history').then((m) => m.AssessorHistoryComponent),
      ...
      },
      {
        path: 'org/branches',
        loadComponent: () =>
          import('./features/org-admin/org-branches/org-branches').then(
            (m) => m.OrgBranchesComponent,
          ),
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./features/assessor/notifications/notifications').then(
            (m) => m.AssessorNotificationsComponent,
          ),
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./features/assessor/calendar/calendar').then((m) => m.Calendar),
      ...
      // GROUP 3: CARBON FOOTPRINT
      {
        path: 'carbon/logs',
        loadComponent: () =>
          import('./features/logs/carbon-logs').then((m) => m.CarbonLogsComponent),
      ...
      // GROUP 2: GREEN OFFICE ASSESSMENTS
      {
        path: 'assessment',
        loadComponent: () =>
          import('./features/green-office/form/form').then((m) => m.GreenOfficeFormComponent),
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./features/assessment/category/category').then((m) => m.CategoryPageComponent),
        title: 'แบบประเมินตนเอง - Green Sync',
        canActivate: [RoleGuard],
        data: { roles: ['SYSTEM_ADMIN', 'ORG_ADMIN', 'USER', 'EMPLOYEE', 'EXECUTIVE'] },
      },
      {
        ...
        loadComponent: () =>
          import('./features/green-office/evidence/evidence').then(
            (m) => m.GreenOfficeEvidenceComponent,
          ),
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./features/org-admin/revision-center/revision-center').then(
            (m) => m.OrgAdminRevisionCenterComponent,
          ),
        title: 'Revision Center - Green Sync',
        canActivate: [RoleGuard],
        data: { roles: ['ORG_ADMIN', 'SYSTEM_ADMIN'] },
      },
      {
        path: 'org-admin/quota-usage',
        loadComponent: () =>
          import('./features/org-admin/quota-usage/quota-usage').then((m) => m.QuotaUsageComponent),
        title: 'การใช้งานโควตา - Green Sync',
        canActivate: [RoleGuard],
        data: { roles: ['ORG_ADMIN', 'SYSTEM_ADMIN', 'EXECUTIVE'] },
      },
      {
        path: 'executive/dashboard',
        loadComponent: () =>
          import('./features/executive/dashboard/dashboard').then(
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./features/executive/leaderboard/leaderboard').then(
            (m) => m.ExecutiveLeaderboardComponent,
          ),
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./features/executive/goal-setting/goal-setting').then((m) => m.GoalSetting),
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./features/executive/audit-summary/audit-summary').then(
            (m) => m.ExecutiveAuditSummaryComponent,
          ),
      ...
      // GROUP 1: ORGANIZATION
      {
        path: 'org/profile',
        loadComponent: () =>
          import('./features/org/profile/profile').then((m) => m.OrgProfileComponent),
...

      {
        ...
        loadComponent: () =>
          import('./features/assessor/profile/profile').then((m) => m.AssessorProfileComponent),
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./features/requests/create/create-request').then((m) => m.CreateRequestComponent),
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./features/requests/evaluate/request-evaluate').then(
            (m) => m.RequestEvaluateComponent,
          ),
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./features/subscription/billing/billing').then((m) => m.BillingComponent),
      ...
      },
      {
        ...
        title: 'การแจ้งเตือน - Green Sync',
        canActivate: [RoleGuard],
        data: { roles: ['SYSTEM_ADMIN', 'ORG_ADMIN', 'USER', 'EMPLOYEE', 'EXECUTIVE', 'ASSESSOR'] },
      },
      {
        path: 'support',
