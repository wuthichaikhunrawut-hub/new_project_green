  ...
  loadAiSummary() {
    ...
    this.insightsService
      ...
      .subscribe({
        ...
        error: () => {
          this.adminAiSummary =
            'เกิดข้อจำกัดในการเชื่อมต่อ AI เนื่องจากโควตา API แบบฟรีถูกใช้งานเต็มลิมิต (ระบบจะรีเซ็ตใน 1 นาที)';
          this.isLoadingAi = false;
          this.cdr.markForCheck();
        },
      });
  ...
  renderCharts() {
    ...
    import('apexcharts').then((module) => {
      ...
      const options = {
        ...
        series: [
          {
            name: 'การเติบโตขององค์กร',
            data: [12, 19, 25, 32, 45, this.stats.totalOrganizations || 50],
          },
        ],
        colors: ['#6366f1'],
        fill: {
