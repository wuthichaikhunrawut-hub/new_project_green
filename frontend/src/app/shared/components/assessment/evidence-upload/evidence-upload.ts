    ...
    <div class="flex flex-col gap-2">
      ...
      <div class="flex items-center gap-3">
        <label class="cursor-pointer">
          ...
          />
          <span
            class="inline-flex items-center gap-2 px-4 py-2 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-lg text-sm font-semibold transition-colors"
          >
        ...
        <div
          *ngIf="fileCount > 0"
          class="flex items-center gap-2 px-3 py-1.5 bg-green-50 border border-green-100 rounded-lg"
        >
        ...
        <span *ngIf="fileCount === 0" class="text-sm text-slate-400 italic"
          >ยังไม่มีการแนบไฟล์</span
        >
      </div>
    </div>
  `,
